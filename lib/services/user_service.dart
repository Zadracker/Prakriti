...
class UserService {
  ...
  // Add an application for becoming an Eco Advocate
  ...
  // Upload a document to Firebase Storage and get the download URL
  ...
  Future<void> downloadApplicationDocument(String url) async {
    try {
      // Example implementation using http package (not included in this snippet)
  ...
  // Redeem a code to update the user's role
  ...
  // Update the Enviro-Coins of a user
